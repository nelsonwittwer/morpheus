  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved checkpoint as @checkpoint" do
        ...
        post :create, {:checkpoint => { "student_id" => "invalid value" }}, valid_session
        assigns(:checkpoint).should be_a_new(Checkpoint)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested checkpoint" do
        ...
        Checkpoint.any_instance.should_receive(:update).with({ "student_id" => "1" })
        put :update, {:id => checkpoint.to_param, :checkpoint => { "student_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the checkpoint as @checkpoint" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Checkpoint.any_instance.stub(:save).and_return(false)
        put :update, {:id => checkpoint.to_param, :checkpoint => { "student_id" => "invalid value" }}, valid_session
        assigns(:checkpoint).should eq(checkpoint)
      end
